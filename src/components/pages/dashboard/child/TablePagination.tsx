...
const TablePagination: React.FC<PaginationProps> = (props) => {
    ...
    return (
        <div className="flex p-x-1 items-center">
            <Pagination className="flex-1">
                <PaginationContent>
                    <PaginationItem onClick={() => { if (page !== 1) { setPage(page - 1) } }}>
                        <PaginationPrevious mobile={window.innerWidth <= getTailwindBreakPointValue("md")} className="hover:text-blue-500" href="#" size={100} />
                    </PaginationItem>
                    {
                    ...
                    <PaginationItem className="rounded p-1" onClick={() => {
                        ...
                        <PaginationNext mobile={window.innerWidth > getTailwindBreakPointValue("md")} className="hover:text-blue-500" href="#" size={0} />
                    </PaginationItem>
                </PaginationContent>
            </Pagination>
